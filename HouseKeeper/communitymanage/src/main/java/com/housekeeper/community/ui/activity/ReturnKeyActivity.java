...
public class ReturnKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getContentViewId() {
        return R.layout.activity_return_key;
    }

    @Override
    protected void initView() {
        setTitle(getString(R.string.community_key_manager_return));
