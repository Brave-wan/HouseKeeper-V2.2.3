...
import com.jinke.housekeeper.saas.report.presenter.AllFragmentPresenter;
...
public class AllFragment extends BaseFragmentV4<AllFragmentView, AllFragmentPresenter> implements
        OnRefreshListener,
        LoadingLayout.OnReloadListener, OnLoadmoreListener,
        AllFragmentView, BaseQuickAdapter.OnItemClickListener {
...
//            }
    ...
    @Override
    public AllFragmentPresenter initPresenter() {
        return new AllFragmentPresenter(getActivity());
    }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        waitBean.setId(String.valueOf(rectifiedBean.getId()));//类型转化
        ...
        if (rectifiedBean != null) {
            ...
            objBeanDetail.setRoomNum(rectifiedBean.getRoomNum());
