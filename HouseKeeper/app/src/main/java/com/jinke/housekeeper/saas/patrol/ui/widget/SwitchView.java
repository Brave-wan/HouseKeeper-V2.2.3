...
public class SwitchView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (isChecked) {
            mBackPaint.setColor(getResources().getColor(R.color.patrol_remind_bg));
            drawRectCir(canvas, getWidth() / 3, getWidth() / 3, getWidth() * 2 / 3, getHeight() / 2, mBackPaint);
            mBackPaint.setColor(getResources().getColor(R.color.patrol_remind_bg));
        } else {
            mBackPaint.setColor(getResources().getColor(R.color.text_color_15));
            drawRectCir(canvas, getWidth() / 3, getWidth() / 3, getWidth() * 2 / 3, getHeight() / 2, mBackPaint);
            mBackPaint.setColor(getResources().getColor(R.color.layout_title_bar_bg));
        }
