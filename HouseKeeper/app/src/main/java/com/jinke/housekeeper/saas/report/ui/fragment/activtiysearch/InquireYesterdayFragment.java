...
import com.jinke.housekeeper.saas.report.presenter.InquireYesterdayFragmentPresenter;
 ...
 */
public class InquireYesterdayFragment extends BaseFragmentV4<InquireYesterdayFragmentView, InquireYesterdayFragmentPresenter> implements
        View.OnClickListener, OnRefreshListener, OnLoadmoreListener,
        LoadingLayout.OnReloadListener, InquireYesterdayFragmentView, BaseQuickAdapter.OnItemClickListener {
    ...
    @Override
    public InquireYesterdayFragmentPresenter initPresenter() {
        return new InquireYesterdayFragmentPresenter(getActivity());
    }
    @Override
