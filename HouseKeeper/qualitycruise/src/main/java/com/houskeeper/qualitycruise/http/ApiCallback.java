package com.houskeeper.qualitycruise.http;

import android.text.TextUtils;

import com.houskeeper.qualitycruise.QualityCruiseApplication;
...
public abstract class ApiCallback<M> extends Subscriber<M> {
    ...
    public void onError(Throwable e) {
        ...
        if (!NetWorksUtils.isConnected(QualityCruiseApplication.instance)) {
