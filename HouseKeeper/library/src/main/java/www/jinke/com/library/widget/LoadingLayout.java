...
public class LoadingLayout extends FrameLayout {
    ...
    private TextView noDataReloadBtn;
    ...
    private static String emptyStr = "暂时未获取到数据，请稍后重试";
    private static String errorStr = "加载数据时发生异常情况，请稍后重试";
    private static String netwrokStr = "请检查您的网络环境是否正常";
    private static String reloadBtnStr = "点击重试";
    private static int emptyImgId = R.drawable.icon_loading_layout_empty;
    private static int errorImgId = R.drawable.icon_loading_layout_error;
    private static int networkImgId = R.drawable.icon_loading_layout_empty_wifi;
    ...
    private void build() {
        ...
        emptyPage = LayoutInflater.from(mContext).inflate(R.layout.widget_empty_page, null);//数据为空
        networkPage = LayoutInflater.from(mContext).inflate(R.layout.widget_nonetwork_page, null);//网络异常
        ...
        noDataReloadBtn = LoadingUtils.findViewById(emptyPage, R.id.no_data_reload_btn);
        ...
        noDataReloadBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            errorReloadBtn.setWidth(LoadingUtils.dp2px(mContext, buttonWidth));
    ...
    public LoadingLayout setReloadButtonTextSize(int sp) {
        ...
        noDataReloadBtn.setTextSize(sp);//
        return this;
    }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        noDataReloadBtn.setTextSize(LoadingUtils.getColor(mContext, id));//
        return this;
    }
    ...
    public LoadingLayout setReloadButtonBackgroundResource(@DrawableRes int id) {
        ...
        noDataReloadBtn.setBackgroundResource(id);//
        return this;
    }
    ...
    public LoadingLayout setOnDataListener(OnDataListener listener) {
