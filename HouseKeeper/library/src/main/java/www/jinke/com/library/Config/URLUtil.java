...
//        stringMap.put("housing", "http://10.15.208.53:8080/house/");
//        return stringMap;
//    }
    public static Map<String, String> getNativeURL() {
        //萝莉
        Map<String, String> stringMap = new HashMap<>();
        stringMap.put("appUrl", "http://10.15.208.46:8080/Cruiselch4/");//所有的基础信息
        stringMap.put("equipmentUrl", "http://10.15.208.46:8089/DeviceMvn/");//设备巡检
        stringMap.put("patrolUrl", "http://10.15.208.46:8080/tqPatrol/");//巡更
        stringMap.put("reportUrl", "http://10.15.208.46:8089/CruMaven/");//配置巡检/工单池
        stringMap.put("handoverRoomUrl", "http://10.15.208.116:8080/device/");//接房
        stringMap.put("housing", "http://10.15.208.46:8080/house/");
        return stringMap;
    }
}
