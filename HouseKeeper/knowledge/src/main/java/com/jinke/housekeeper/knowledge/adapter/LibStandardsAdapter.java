...
import www.jinke.com.library.widget.RecyclerImageView;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindHolder(String path) {
            Picasso.with(mContext).load(path)
                    ...
                    .placeholder(R.drawable.icon_knowledge_lib_moren)//加载中
                    .error(R.drawable.icon_knowledge_lib_moren)//加载失败
                    .into(imageView);
        }
    }
}
